...
async function getClientBalance(id) {
    return axios.get('http://65.2.3.57:8080/client/clientBalance/'+id)
    .then(response => {
...
async function getRoboAdvice(id) {
    return axios.get('http://65.2.3.57:8080/client/roboAdvisor/'+id)
    .then(response => {
        console.log(response.data);
        return response.data
    });
...
async function getTradeHistory(id) {
    return axios.get('http://65.2.3.57:8080/client/tradeHistory/'+id)
    .then(response => {
        console.log(response.data);
        return response.data
    });
...
async function postTrade(postRequest) {
    return axios.post('http://65.2.3.57:8080/client/trade', postRequest)
    .then(response => {
        console.log(response.data);
        return response.data
    });
...
async function getHoldings(id) {
    return axios.get('http://65.2.3.57:8080/client/holdings/'+id)
    .then(response => {
        console.log(response.data);
        return response.data
    });
...
async function getPrices() {
    return axios.get('http://65.2.3.57:8080/client/prices')
    .then(response => {
        console.log(response.data);
        return response.data
    });
...
async function postPref(postRequest) {
    return axios.post('http://65.2.3.57:8080/client/pref', postRequest)
    .then(response => {
        console.log(response.data);
        return response.data
    });
...
async function putPref(updatedPref) {
    return axios.put('http://65.2.3.57:8080/client/pref', updatedPref)
    .then(response => {
        console.log(response.data);
        return response.data
    });
...
async function getPref(id) {
    return axios.get('http://65.2.3.57:8080/client/pref/'+id)
    .then(response => {
        console.log(response.data);
        return response.data
    });
...
async function clientLogin(loginRequest) {
    return axios.post('http://65.2.3.57:8080/client/login', loginRequest)
    .then(response => {
        console.log(response.data);
        return response.data
    });
...
async function clientRegister(registerRequest) {
    return axios.post('http://65.2.3.57:8080/client/register', registerRequest)
    .then(response => {
        console.log(response.data);
        return response.data
    });
